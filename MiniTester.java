...
public class MiniTester {
    ...
    public static boolean testFindPath3Args() { // 1 point
        ...
        if (shortest.g.computePathCost(path) != 7) {
            System.out.println("Path cost should be 7. but you got " + shortest.g.computePathCost(path));
            return false;
        }
        return true;
    }
    ...
    public static boolean testSafeFindPath1() { // 1 point
         ...
         */
        if (path.size() != 7) {
            System.out.println("Path length (number of vertices, including start and end) should be 7. But you got " + path.size());
            return false;
        }
    ...
    public static boolean testSafeFindPath3() { // 1 point
        ...
        if (shortest.costGraph.computePathCost(path) != 8) {
            System.out.println("Path cost should be 8. but you got " + shortest.costGraph.computePathCost(path));
            return false;
        }
        return true;
    }
